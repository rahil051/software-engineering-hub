/*
 ...
 ## READ IT (Exercise 4 of 17)  
   
 ## Implementing a Readable Stream  
   
  To implement a Readable stream, you need to construct an object, or  
  inherit, from stream.Readable class and implement a _read() method in it.  
 ...
 ### Reading modes  
  ...
  Readable streams operate in one of two modes: flowing and paused.  
   ...
   » In flowing mode, data is read from the underlying system automatically                                                                            
     and provided as quickly as possible.                                        
   » In paused mode, the read() method must be called explicitly to read                                                                            
