/*
 ...
 ## Writable Streams  
  ...
  To create a custom Writable stream you must call the new  
  stream.Writable(options) constructor and implement the _write() and/or  
  _writev() method  
 ...
 ### _write method  
  ...
  The _write method is used to send data to the underlying resource. This  
  method MUST NOT be called by your application code directly. Instead it's  
